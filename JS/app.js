...
<g>
    ...
    ['responsive', 'html', 'css', 'css3', 'javascript', 'toilet', 'flexbox', ], {
        performance: 98,
        accessibility: 83,
        bestpractices: 100,
        seo: 92
...
function displayModal() {
    ...
    <input class="searchBox" onfocus = "searchFunction()" type="text" name="search" id="search" >
    ...
    projectsCollection.forEach(project => {
        ...
        iconDescriptionText.textContent = project.description;;
...
let formatDetailedProject = function (project) {
    ...
    toolTipTextPages.setAttribute("style", "border: solid 2px " + selectedProject.colorCode + ";color:" + selectedProject.colorCode);
    ...
    toolTipTextRepo.setAttribute("style", "border: solid 2px " + selectedProject.colorCode + ";color:" + selectedProject.colorCode);
    ...
    extendedProjectDiv.innerHTML = selectedProject.thumbnail;
    extendedProjectDiv.append(toolTipContainer, descriptionText);
